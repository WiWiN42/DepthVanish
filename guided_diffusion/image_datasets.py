...
def load_data(
    *,
    ...
    gt_files, tv_files = _list_tv_img_files(data_dir)
    all_files = gt_files+tv_files
...
def _list_tv_img_files(data_dir):
    ...
    gt_files = [] # the ground-truth images
    tv_files = [] # the time-variant images
        ...
        for img in sorted(bf.listdir(img_dir)):
            ...
            if img.endswith(('.jpg', '.jpeg', '.png')):
                if img.startswith('1_'):
                    gt_files.append(img_path)
                if img.startswith('2_'):
                    tv_files.append(img_path)

    return gt_files, tv_files
