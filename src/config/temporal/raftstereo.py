exp = dict(
    gpu=2,
    name='raftstereo_vkitti2_scene18_clone_frame296_id5_base', # model_dataset_scene_variation_patch
    round=200,
    n_checkpoint=10,
    save_dir='/data3/luqi/yxing/stereo_PhysicalAttack/results/temporal/distance',
    log_level='debug',
)
...
model = dict(
    name='raftstereo', 
    ckpt='/data3/luqi/yxing/stereo_PhysicalAttack/src/model/_checkpoints/raftstereo-sceneflow.pth', # psmnet
    loss = dict(
        unit_norm=True,
        alpha=0.1,
        beta=0.01,
