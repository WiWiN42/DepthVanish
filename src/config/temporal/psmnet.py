exp = dict(
    gpu=0,
    name='psmnet_vkitti2_scene18_clone_frame296_id5', # model_dataset_scene_variation_patch
    round=100,
    n_checkpoint=5,
...
model = dict(
    ...
    ckpt='/data3/luqi/yxing/stereo_PhysicalAttack/src/model/_checkpoints/pretrained_model_KITTI2015.tar', # psmnet
    loss = dict(
        unit_norm=True,
        alpha=0.1,
        beta=0.01,
